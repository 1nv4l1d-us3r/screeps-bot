...
//     private static PERMANENT_CACHE: Map<string, Id<any>[]> = new Map();
//     private static TEMPORARY_CACHE: Map<string, Id<any>[]> = new Map();
...
//     private static isFindConstantPermanent(findConstant: FindConstant) {
//         return PERMANENT_CACHE_FIND_SET.has(findConstant);
//     }

//     private static convertResultToIdList(result:ReturnType<typeof Room.prototype.find>):Id<any>[] {
...
//         this.PERMANENT_CACHE.set(cacheKey, this.convertResultToIdList(findResult));
//         return findResult;
//     }
...
//         if(this.isFindConstantPermanent(findConstant)) {
